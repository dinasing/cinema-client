...
import EditCinemaHallContainer from '../../cinema/components/EditCinemaHallContainer';
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <ProtectedRoute
          exact
          path="/movie-theaters/:id/halls/:hallId/edit"
          component={EditCinemaHallContainer}
          store={store}
        />
